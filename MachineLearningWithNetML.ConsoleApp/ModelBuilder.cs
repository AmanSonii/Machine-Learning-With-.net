...
namespace MachineLearningWithNetML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\47billion\source\repos\MachineLearningWithNet\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../MachineLearningWithNetML.Model/MLModel.zip";
